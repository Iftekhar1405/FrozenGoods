...
const AuthForm = () => {
  ...
  const handleRegister = (e: any) => {
    ...
    setMessage("OTP sent to your phoneNumber");
    toast({
      title: "OTP Sent",
      description: "Please check your phoneNumber for the verification code",
      status: "success",
      duration: 3000,
      isClosable: true,
    });
    ...
    <VStack spacing={6} align="stretch">
      <FormControl>
        <FormLabel textAlign="center">
          Enter the verification code sent to your phoneNumber
        </FormLabel>
